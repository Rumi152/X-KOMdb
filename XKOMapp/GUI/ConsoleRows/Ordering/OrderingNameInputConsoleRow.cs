...
{
    internal class OrderingNameInputConsoleRow : ICustomCursorConsoleRow, ICustomKeystrokeListenerConsoleRow, IHoverConsoleRow, IInteractableConsoleRow, IFocusableConsoleRow
    {
        ...
        public OrderingNameInputConsoleRow(string markupLabel, int maxLength, bool isFocused = false)
        {
